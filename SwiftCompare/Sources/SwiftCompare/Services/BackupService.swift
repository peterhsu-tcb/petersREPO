...
class BackupService {
    ...
    private let backupDirectoryName = ".swiftcompare_backups"
    ...
    /// - Parameter fileURL: The original file URL
    /// - Returns: URL to the backup directory
    ...
    /// - Parameter fileURL: URL of the file to backup
    /// - Returns: BackupInfo containing details about the backup
    ...
    /// - Parameter backupInfo: The backup information
    ...
    ///   - originalURL: URL where the file should be restored
